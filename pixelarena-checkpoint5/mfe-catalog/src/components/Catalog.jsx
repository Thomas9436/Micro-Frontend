...
function ProductCard({ product }) {
  const handleAddToCart = () => {
    console.log('[Catalog] Produit cliqué:', { id: product.id, name: product.name, price: product.price });
    // Emettre un evenement via l'eventBus contenant les infos du produit
