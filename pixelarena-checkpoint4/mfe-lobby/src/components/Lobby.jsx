...
function GameCard({ game }) {
  const handleJoinGame = () => {
    // Signaler au reste de l'application qu'un joueur a rejoint cette partie
    // On envoie l'id et le nom de la partie pour information
    eventBus.emit('lobby:playerJoined', { id: game.id, name: game.name });
  };
